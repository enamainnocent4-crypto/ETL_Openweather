...
# #     raise ValueError("Une ou plusieurs variables d'environnement sont manquantes dans le enama.env")
...
#     if not all([DB_USER, DB_PASSWORD, DB_HOST, DB_PORT, DB_NAME]):
#         raise ValueError(
#             "Une ou plusieurs variables d'environnement sont manquantes dans le enama.env"
#         )
